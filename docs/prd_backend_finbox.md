...
- MockMvc para testes HTTP/controllers.
- Spring Security Test para segurança.
- Testcontainers PostgreSQL para banco real, Flyway e isolamento.
- Surefire roda `*Test`; Failsafe roda `*IT`.
